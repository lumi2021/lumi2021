...
<p>
    <picture>
        <source media="(max-width: 820px)" srcset="actions/cache/steam/game_banners/recent/1454400_thin.svg">
    ...
    <picture>
        <source media="(max-width: 820px)" srcset="actions/cache/steam/game_banners/recent/246620_thin.svg">
    ...
    <picture>
        <source media="(max-width: 820px)" srcset="actions/cache/steam/game_banners/recent/346010_thin.svg">
        <img src="actions/cache/steam/game_banners/recent/346010_wide.svg" width="410" style="max-width: 100%; padding: 5px;" alt="Besiege">
    </picture>
    <picture>
        <source media="(max-width: 820px)" srcset="actions/cache/steam/game_banners/recent/250900_thin.svg">
